...
func (x *StatusKanban) GetMetadata() *_struct.Struct {
	if x != nil {
		return x.Metadata
	}
	return nil
...
func (x *SendContext) GetContext() *any.Any {
	if x != nil {
		return x.Context
	}
	return nil
...
func (x *OutputRequest) GetMetadata() *_struct.Struct {
	if x != nil {
		return x.Metadata
	}
	return nil
...
func (x *Request) GetMessage() *any.Any {
	if x != nil {
		return x.Message
	}
	return nil
...
func (x *Response) GetMessage() *any.Any {
	if x != nil {
		return x.Message
	}
	return nil
...
var file_proto_kanbanpb_status_proto_rawDesc = []byte{
	...
	0x64, 0x53, 0x74, 0x61, 0x74, 0x75, 0x73, 0x28, 0x01, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f,
	0x33,
}
